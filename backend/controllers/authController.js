...
export const signUp=async (req,res)=>{
    ...
    try {
        ...
        if(existUser){
            return res.status(400).json({message:"email already exist"})// frontend ko ye message send karna baaki wo dekhlega
        }
        ...
        let hashPassword = await bcrypt.hash(password,10)// ye do kaam karta pahla salt banyega aur phir encrypt kardega password ko
